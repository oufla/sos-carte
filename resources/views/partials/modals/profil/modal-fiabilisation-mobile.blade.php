<div wire:ignore.self class="modal fade dialogbox" id="fiabiliser-mobile" data-bs-backdrop="static" tabindex="-1"
    style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header pt-1 px-2">
                <div class="modal-title m-0">
                    <h5 class="m-0">Fiabiliser mon mobile</h5>
                </div>
            ...
            <div class="modal-body text-start mb-2">
                @if (!empty($step) && $modal['name'] === 'fiabilisation')
                                ...
                                <li>
                                    <div class="item px-0">
                                        <div class="icon-box bg-theme-primary custom">
                                            @if (!empty($mobile['operator']))
                                                <img src="{{ asset('/storage/images/operators/' . $mobile['operator'] . '.png') }}"
                                        ...
                                        @foreach ($step['fields'] as $indexField => $field)
                                            @if ($field === true)
                                                <div class="input-wrapper mb-2">
                                                    <label class="label" for="{{ $indexField }}">Code OTP</label>
                                                    <input type="text" class="form-control" id="{{ $indexField }}"
                                                        placeholder="">
                                                    <i class="clear-input">
                    ...
                    @if ($step['name'] === 'done')
                        <div id="fiabilisation-success" class="modal-content">
                            ...
                            <div class="modal-body px-0 mt-1">
                                Votre téléphone a bien été fiabilisé.
                            </div>
                            <div class="modal-footer">
                                <div class="btn-inline">
